...
def _execute_and_record_after_paper_exit_preflight(
    ...
    *,
    ...
    if trading_mode == "PAPER" and not is_exit:
        ...
        emit_strategy_event(
            event_type="PAPER_POSITION_OPENED", decision=side,
            reason="POSITIONS_OPEN_OK_ATOMIC", price=price,
            candle_open_time=candle_open_time,
            info={"pos_id": atomic.position_id},
        )
        return {
...
def run_long_horizon_l3_owner_cycle():
    ...
    res = execute_and_record(
        ...
        allow_meta={"authority": "LOCAL_PAPER_L3"}, rsi_14=None, ema_21=None,
    )
