...
CREATE TABLE IF NOT EXISTS public.long_horizon_l3_admission_v1(
 ...
 entry_notional numeric NOT NULL, entry_price numeric NOT NULL,
 instrument_min_qty numeric NOT NULL, instrument_min_notional numeric NOT NULL,
 effective_min_notional numeric NOT NULL, status text NOT NULL, decision_id uuid,
...
WITH frozen AS (
 SELECT clock_timestamp() AS cutoff,
        jsonb_build_object(
          ...
          'sampling_contract_fingerprint','0f67b3c42d19ab5447dc4b1e9a9f0e553f62c3b72d88bdc8d9dc64b36f0312d1',
