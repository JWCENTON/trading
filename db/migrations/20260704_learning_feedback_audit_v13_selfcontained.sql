...
CREATE VIEW v_learning_feedback_audit_v1 AS
...
CREATE VIEW v_learning_feedback_summary_v1 AS
SELECT
  learning_status,
  COUNT(*) AS trades,
...
CREATE VIEW v_learning_feedback_missing_components_v1 AS
SELECT
  missing_component,
  COUNT(*) AS trades
...
CREATE VIEW v_mme_learning_available_context_v1 AS
SELECT
  symbol,
  "interval",
...
CREATE VIEW v_mme_learning_missing_recent_v1 AS
SELECT
  a.position_id,
  a.exit_time,
  a.symbol,
...
CREATE VIEW v_mme_learning_slot_coverage_v1 AS
SELECT
  symbol,
  "interval",
  strategy,
